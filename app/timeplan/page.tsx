          ...
          {formats.map((f, i) => (
            <div key={i} className="flex items-start gap-4 p-5 bg-[#F8F7F4] rounded-xl border border-[#E2DDD7]">
              ...
              <div>
                ...
                <p className="font-[family-name:var(--font-dm)] text-[#111110] text-xs mt-0.5 leading-relaxed">{f.desc}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-5">
            ...
            <p className="font-[family-name:var(--font-dm)] text-[#111110] text-sm leading-[1.8]">
