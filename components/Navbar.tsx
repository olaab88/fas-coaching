      ...
      >
        <nav className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <button
            ...
            className="md:hidden p-2 rounded-lg text-[#111110] hover:text-[#111110] hover:bg-[#EFECEA] transition-colors cursor-pointer"
            aria-label="Meny"
          >
              ...
              <Link
                ...
                className={`px-4 py-3 rounded-lg font-[family-name:var(--font-dm)] text-sm transition-colors ${
                  pathname === l.href
                    ...
                    : "text-[#111110] hover:text-[#111110] hover:bg-[#F8F7F4]"
                }`}
              >
                {l.label}
              </Link>
